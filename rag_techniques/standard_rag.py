...
class StandardRAG:
    ...
    def _setup_retrievers(self):
        ...
        datasets = ["tech_docs", "faq_data", "news_articles"]  # Support all datasets
                ...
                class CustomRetriever:
                    ...
                    def get_relevant_documents(self, query: str, k: int = 5):
                        try:
                            ...
                            self.logger(f"Retrieved {len(documents)} documents using similarity search")
                            return documents
    ...
    def process_query(self, query: str, dataset: str) -> Tuple[str, List[str]]:
        ...
        try:
            ...
            self._log("Standard RAG completed: Single retrieval → Direct generation")
